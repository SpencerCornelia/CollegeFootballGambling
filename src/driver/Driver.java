...
public class Driver {
	...
	public static void main(String[] args) {
		...
		String[] teamToEditList = {"Cal", "W Michigan", "Miami (OH)", "Appalachian St", "Ga Southern", "Washington St", "UMass", "E Michigan", "UConn", "Cent Michigan", "New Mexico St", "UL Monroe", "UL Lafayette", "Southern Miss", "Ole Miss", "Mid Tennessee", "FIU", "FAU", "Miss St", "NC State", "Miami", "San José State", "W Kentucky", "LA Tech"};
		
		// list of updated names to update in DB - make sure this list mirrors teamToEditList
		String [] teamEditList = {"California", "Western Michigan", "Miami (Ohio)", "Appalachian State", "Georgia Southern", "Washington State", "Massachusetts", "Eastern Michigan", "Connecticut", "Central Michigan", "New Mexico State", "Louisiana-Monroe", "Louisiana-Lafayette", "Southern Mississippi", "Mississippi", "Middle Tennessee", "Florida International", "Florida Atlantic", "Mississippi State", "North Carolina State", "Miami (Florida)", "San Jose State", "Western Kentucky", "Louisiana Tech"};
